use crate::backends::{Backend, factory};
...
impl Database {
  #[napi(constructor)]
  pub fn new(type_: String, settings: Settings, wrapper_settings: Option<WrapperSettings>) -> Self {
  ...
  #[napi(js_name = "setSub")]
  pub async fn set_sub(&self, key: String, path: Vec<String>, value: Option<Value>) -> Result<()> {
